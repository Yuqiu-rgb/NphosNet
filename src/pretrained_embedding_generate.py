...
if __name__ == "__main__":
    ...
    # ----------------- For PK dataset ----------------------
    np.save('../embedding/PK_train_embedding.npy',x_train_encoding)
    np.save('../embedding/PK_test_embedding.npy',x_test_encoding)
    # print('-end-')
    # ------------------------------------------------------

    # ----------------- For PR dataset ----------------------
    # np.save('../embedding/PR_train_embedding.npy',x_train_encoding)
    # np.save('../embedding/PR_test_embedding.npy',x_test_encoding)
    print('end')